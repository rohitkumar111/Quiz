...
<h1 align="center">Welcome To Deletion Block</h1>

<table align="center">
	<form method="post" action="deleteq.php">
		<tr>
			...
			while($data = mysqli_fetch_assoc($run))
			{
				...
				<tr align="center">
			    	...
			    	<tr>
			   	   ...
			   	   <tr>
			   	   		<td colspan="2" align="center"><a href="deletequestion.php?sid=<?php echo $data['id']; ?>">Delete</a></td>
			   	   </tr>
			    <?php 
			}
		}
